...
lable=Label(root,text="Voter Portal",foreground="Black",font="Rockwell 28 bold")
lable.pack(pady=(15,0))

image=Image.open("voteimg.png")
image = image.resize((700,400))
photo1=ImageTk.PhotoImage(image)
logo_label=Label(image=photo1)
logo_label.place(x=50,y=190)

regbtn=Button(root,text="Register",bg="blue",fg="white",font="BerlinSans 18 bold",command=move_to_old_login)
...
logbtn=Button(root,text="Login",fg="Blue",font="calibri 17 bold underline",border=0,cursor="hand2",command=move_to_voter_log)
