...
def move_to_change_pass():
    ...
    try:
        ...
        if row:
            ...
            root.destroy()
            call(["python","echangepass.py",voterid])
        else:
...
admin_lable=Label(root,text="Voter Register",bg="white",fg="Black",font="Rockwell 22 bold")
...
log_btn=Button(frame1,text="Log In", foreground="White",background="Blue",font="Candara 16 bold",command=move_to_change_pass)
